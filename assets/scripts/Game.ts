...
import { dailySigninManager } from './signin/DailySigninManager';
...
import { autoSaveManager } from './save/AutoSaveManager';
...
import { onlineRewardManager } from './onlinereward/OnlineRewardManager';
...
import { skillTreeManager } from './hero/HeroManager';
...
export class Game extends Component {
    ...
    private collectSaveData(): SaveData {
        return {
            ...
            randomEvents: randomEventManager.getSaveData()
        };
    }
    ...
    private onSaveLoaded(data: { slotId: number; data: SaveData }): void {
        ...
        if (saveData) {
            ...
            if (saveData.randomEvents) {
                randomEventManager.loadSaveData(saveData.randomEvents);
            }
        }
